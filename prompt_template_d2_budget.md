...
- Livret A : ouverture 10 euros, plafond 22 950 euros, taux 1,5%, disponibilite immediate, tout age
- Livret jeune : ouverture 10 euros, plafond 1 600 euros, taux minimum 1,5% (fixe par la banque), disponibilite immediate, 12-25 ans domicilie en France
- LDDS : ouverture 15 euros, plafond 12 000 euros, taux 1,5%, disponibilite immediate, majeurs domicile fiscal en France
- PEL : versement initial 225 euros puis 540 euros minimum par an, plafond 61 200 euros, taux 2% (si ouvert a partir du 01/01/2026), bloque 4 ans (retrait avant possible avec consequences), projet immobilier
- CEL : ouverture 300 euros puis 75 euros minimum par operation, plafond 15 300 euros, taux 1%, disponibilite selon regles du compte, fiscalite specifique
- LEP : ouverture 30 euros, plafond 10 000 euros, taux 2,5%, disponibilite immediate, reserve aux personnes domiciliees fiscalement en France sous condition de revenus
...
- **Prenom du personnage** : [ex: REDACTED, REDACTED, Inaya, Rayan, Jade, Enzo...]
- **Age** : [17-25 ans]
...
```json
{
  ...
  "documents": [
    ...
    },
    {
      ...
      "type": "texte",
      "titre": "Les types d'epargne",
      "contenu": "DIFFERENTS TYPES D'EPARGNE (taux en vigueur a partir du 1er fevrier 2026)\n\nLivret A : ouverture 10 euros, plafond 22 950 euros, taux 1,5%, disponibilite immediate, accessible a tout age.\n\nLivret jeune : ouverture 10 euros, plafond 1 600 euros, taux minimum 1,5% (fixe par la banque), disponibilite immediate, reserve aux 12-25 ans domicilies en France.\n\nLDDS (Livret de developpement durable et solidaire) : ouverture 15 euros, plafond 12 000 euros, taux 1,5%, disponibilite immediate, reserve aux majeurs avec domicile fiscal en France.\n\nCEL (Compte epargne logement) : ouverture 300 euros, plafond 15 300 euros, taux 1%, disponibilite selon regles du compte, fiscalite specifique.\n\nPlan epargne logement (PEL) : versement initial 225 euros, puis 540 euros minimum par an, plafond 61 200 euros, taux 2% (si ouvert a partir du 01/01/2026), montant bloque 4 ans (retrait avant possible avec consequences), pour un projet immobilier.\n\nLivret d'epargne populaire (LEP) : ouverture 30 euros, plafond 10 000 euros, taux 2,5%, disponibilite immediate, reserve aux personnes sous condition de revenus.\n\nNote : les taux d'interet peuvent evoluer. Pour le PEL, le taux depend de la date d'ouverture du plan.\n\nEPARGNE DE PRECAUTION\nL'epargne de precaution est une somme mise de cote pour faire face aux depenses imprevues (panne, reparation, sante). Elle doit etre disponible immediatement."
    }
  ],
  "questions": [
    {
    ...
    },
    {
      ...
      "points": 1,
      "competence": "C5",
      "correction": "Yanis peut choisir le Livret A (accessible a tous, disponible immediatement, taux 1,5%), le Livret jeune (il a 18 ans, donc moins de 25 ans, disponible immediatement, taux minimum 1,5%) ou le LEP (revenus modestes, meilleur taux a 2,5%). Le PEL ne convient pas car l'argent est bloque 4 ans.",
      "explication": "Pour choisir une epargne, on verifie : la disponibilite de l'argent, le taux d'interet, et les conditions d'ouverture (age, revenus). Taux en vigueur a partir du 1er fevrier 2026.",
